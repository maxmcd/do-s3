/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce9433a519d960e7c2e3ba26c9a36481)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Terminal" | "S3";
	}
	interface Env {
		S3_JWT_SECRET: "demo-secret-change-in-production";
		S3: DurableObjectNamespace<import("./worker/index").S3>;
		TERMINAL: DurableObjectNamespace<import("./worker/index").Terminal>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "S3_JWT_SECRET">> {}
}
